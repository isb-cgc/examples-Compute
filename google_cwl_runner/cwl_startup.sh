...
if [[ ${RUNNER} == "cwltool" ]]; then
  sudo apt-get update
  sudo apt-get --yes install apt-utils gcc python-dev python-setuptools ca-certificates nodejs curl apt-transport-https software-properties-common gnupg2
  ...
  echo "Printing File List for data/input"
  ls -lha /mnt/data/input

  echo "Printing File List for data"
  ls -lha /mnt/data/
